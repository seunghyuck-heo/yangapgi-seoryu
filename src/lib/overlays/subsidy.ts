...
export const subsidyOverlay: OverlayDoc = {
  ...
  fields: [
    ...
    { key: "apply_year", type: "text", x: 42.49, y: 74.63, w: 4.6, h: 1.2, label: "신청 연도", align: "right", dateGroup: "apply", datePart: "y", fullYear: true, autoToday: true },
    { key: "apply_month", type: "text", x: 48.8, y: 74.63, w: 2.8, h: 1.2, label: "신청 월", align: "right", dateGroup: "apply", datePart: "m", autoToday: true },
    { key: "apply_day", type: "text", x: 53.31, y: 74.63, w: 2.8, h: 1.2, label: "신청 일", align: "right", dateGroup: "apply", datePart: "d", autoToday: true },
    ...
    { key: "applicant_phone", type: "text", x: 35.47, y: 80.49, w: 15, h: 1.2, label: "신청인 연락처", prefix: "010-", dashPattern: [4, 4], align: "left" },
  ],
};
