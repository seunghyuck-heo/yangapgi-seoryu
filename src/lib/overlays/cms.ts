...
export const cmsOverlay: OverlayDoc = {
  ...
  fields: [
    ...
    { key: "sign_y", type: "text", x: 79.01, y: 78.45, w: 5.6, h: 1.2, label: "작성 연도", align: "right", dateGroup: "sign", datePart: "y", fullYear: true, autoToday: true },
    { key: "sign_m", type: "text", x: 86.52, y: 78.45, w: 3, h: 1.2, label: "작성 월", align: "right", dateGroup: "sign", datePart: "m", autoToday: true },
    { key: "sign_d", type: "text", x: 91.44, y: 78.45, w: 3, h: 1.2, label: "작성 일", align: "right", dateGroup: "sign", datePart: "d", autoToday: true },
