...
export const poaOverlay: OverlayDoc = {
  ...
  fields: [
    ...
    { key: "sign_y", type: "text", x: 78.23, y: 84.51, w: 5.6, h: 1.34, label: "작성 연도", align: "right", dateGroup: "sign", datePart: "y", fullYear: true },
    { key: "sign_m", type: "text", x: 85.88, y: 84.51, w: 3, h: 1.34, label: "작성 월", align: "right", dateGroup: "sign", datePart: "m" },
    { key: "sign_d", type: "text", x: 90.93, y: 84.51, w: 3, h: 1.34, label: "작성 일", align: "right", dateGroup: "sign", datePart: "d" },
