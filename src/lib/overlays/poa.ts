...
export const poaOverlay: OverlayDoc = {
  ...
  fields: [
    ...
    { key: "gigan_end_y", type: "text", x: 34.55, y: 78.49, w: 5.6, h: 1.34, label: "위임 종료 연도", align: "right", dateGroup: "gigan_end", datePart: "y", fullYear: true, autoToday: true, autoTodayOffsetYears: 5, autoTodayOffsetDays: -1 },
    { key: "gigan_end_m", type: "text", x: 42.13, y: 78.49, w: 3, h: 1.34, label: "위임 종료 월", align: "right", dateGroup: "gigan_end", datePart: "m", autoToday: true, autoTodayOffsetYears: 5, autoTodayOffsetDays: -1 },
    { key: "gigan_end_d", type: "text", x: 47.11, y: 78.49, w: 3, h: 1.34, label: "위임 종료 일", align: "right", dateGroup: "gigan_end", datePart: "d", autoToday: true, autoTodayOffsetYears: 5, autoTodayOffsetDays: -1 },
