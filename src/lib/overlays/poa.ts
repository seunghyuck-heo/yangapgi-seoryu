...
export const poaOverlay: OverlayDoc = {
  ...
  fields: [
    ...
    { key: "gigan_start_d", type: "text", x: 27.06, y: 78.49, w: 3, h: 1.34, label: "위임 시작 일", align: "right", dateGroup: "gigan_start", datePart: "d" },
    { key: "gigan_end_y", type: "text", x: 34.55, y: 78.49, w: 5.6, h: 1.34, label: "위임 종료 연도", align: "right", dateGroup: "gigan_end", datePart: "y", fullYear: true },
    { key: "gigan_end_m", type: "text", x: 42.13, y: 78.49, w: 3, h: 1.34, label: "위임 종료 월", align: "right", dateGroup: "gigan_end", datePart: "m" },
    { key: "gigan_end_d", type: "text", x: 47.11, y: 78.49, w: 3, h: 1.34, label: "위임 종료 일", align: "right", dateGroup: "gigan_end", datePart: "d" },
    { key: "sign_y", type: "text", x: 78.23, y: 84.51, w: 5.6, h: 1.34, label: "작성 연도", align: "right", dateGroup: "sign", datePart: "y", fullYear: true, autoToday: true },
    { key: "sign_m", type: "text", x: 85.88, y: 84.51, w: 3, h: 1.34, label: "작성 월", align: "right", dateGroup: "sign", datePart: "m", autoToday: true },
    { key: "sign_d", type: "text", x: 90.93, y: 84.51, w: 3, h: 1.34, label: "작성 일", align: "right", dateGroup: "sign", datePart: "d", autoToday: true },
