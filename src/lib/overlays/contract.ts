...
export const contractOverlay: OverlayDoc = {
  ...
  fields: [
    ...
    // 개인정보 수집·이용 동의 체크박스
    { key: "consent_yes", type: "checkbox", x: 73, y: 87.8, w: 6, h: 1.6, label: "개인정보 수집·이용 동의", group: "consent" },
    { key: "consent_no", type: "checkbox", x: 82.5, y: 87.8, w: 8, h: 1.6, label: "동의하지 않음", group: "consent" },
